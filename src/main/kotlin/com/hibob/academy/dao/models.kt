...
data class PetInsert(val name: String,val type: String, val companyId: Long,val ownerId:Long?)

data class OwnerData(val id:Long,val name: String, val employeeId:Long, val companyId: Long)
data class OwnerInsert(val name: String, val employeeId:Long, val companyId: Long)
